...
| `kgosd` local daemon、Rust Kernel / Lithograph host、TypeScript/npm 上层分工 | client ↔ daemon transport、process discovery/lifecycle、HTTP/local carrier、package layout 与开发/分发方式 |
