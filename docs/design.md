...
| 工程待办 | Phase 05 已完成；Object继续不实现 list/search。[Phase 06 Evolution Core](development/phases/06-evolution-core.md) 当前为 `in_progress`，Core State / ref / History / Diff / HTTP / CLI 已完成本地实现、主树 full validation、独立 fresh-source validation 与 Phase Review；只剩 pushed SHA 的 Ubuntu CI 完成条件。Merge Session 及完整 SDK / Web / Skill仍在后续。具体阶段顺序见[开发计划](development/README.md)，复用边界见[工程映射](design/implementation.md) |
