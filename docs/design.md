...
| [decisions.md](design/decisions.md) | D1–D73 的决定、依据、备选和取舍，以及被替换架构记录 |
...
| 工程待办 | Phase 04 已完成；Object继续不实现 list/search。[Phase 05 Graph Query & Execute](development/phases/05-graph.md) 当前为 `in_progress`：本地实现、Review、主树/fresh-source验收已闭环，仍需最终 pushed SHA 的 Ubuntu Validate 后才能 `done`。Evolution / Merge 及完整 SDK / Web / Skill仍在后续。具体阶段顺序见[开发计划](development/README.md)，复用边界见[工程映射](design/implementation.md) |
