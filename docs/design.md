...
| 工程待办 | Phase 04 已完成；Object继续不实现 list/search。下一阶段从对应 Design Inputs 建立计划后，再实现 Graph 公共 HTTP、Evolution / Merge 及完整 SDK / Web / Skill。具体阶段顺序见[开发计划](development/README.md)，复用边界见[工程映射](design/implementation.md) |
