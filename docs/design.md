...
| 工程待办 | Phase 06 Evolution Core 已完成；Object继续不实现 list/search。Merge Session 及完整 SDK / Web / Skill仍在后续，开始下一阶段前再按对应 Design Inputs 建立计划与 Acceptance。具体阶段顺序见[开发计划](development/README.md)，复用边界见[工程映射](design/implementation.md) |
