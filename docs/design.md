...
| 工程待办 | Phase 05 已完成；Object继续不实现 list/search。Evolution / Merge 及完整 SDK / Web / Skill仍在后续。具体阶段顺序见[开发计划](development/README.md)，复用边界见[工程映射](design/implementation.md) |
